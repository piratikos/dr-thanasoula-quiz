...
export default function Quiz(){
  ...
  <div style={{textAlign:"center",marginBottom:28}}>
    ...
    <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:done?26:24,fontWeight:800,color:"#1a1207",lineHeight:1.15}}>{done?(r?.ish?"Εξαιρετική Κατάσταση! 🌟":`${ct?.name?.split(" ")[0]||""}, Ο Τύπος Γήρανσής σας`):<>Τι Τύπο Γήρανσης Έχετε<br/>και Ποια Εξέταση Ταιριάζει σε Εσάς;</>}</h1>
